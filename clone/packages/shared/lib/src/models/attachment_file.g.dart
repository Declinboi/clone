...
_$PreparingImpl _$$PreparingImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$PreparingImpl', json, ($checkedConvert) {
...
_$InProgressImpl _$$InProgressImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$InProgressImpl', json, ($checkedConvert) {
...
_$SuccessImpl _$$SuccessImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$SuccessImpl', json, ($checkedConvert) {
...
_$FailedImpl _$$FailedImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$FailedImpl', json, ($checkedConvert) {
