...
// Dummy SubmissionStatusMessage class definition.
// Replace this with the actual implementation or import if it exists elsewhere.
class SubmissionStatusMessage {
  final String title;
  final String description;

  const SubmissionStatusMessage({this.title = '', this.description = ''});
